...
exports.sortHandlers = exports.TraceProcessor = exports.TraceParseProgressEvent = void 0;
...
exports.TraceParseProgressEvent = TraceParseProgressEvent;
class TraceProcessor extends EventTarget {
    ...
    constructor(traceHandlers, { pauseDuration = 1, eventsPerChunk = 15000 } = {}) {
        super();
...
var IteratorItemType;
(function (IteratorItemType) {
    IteratorItemType[IteratorItemType["TRACE_EVENT"] = 1] = "TRACE_EVENT";
    IteratorItemType[IteratorItemType["STATUS_UPDATE"] = 2] = "STATUS_UPDATE";
