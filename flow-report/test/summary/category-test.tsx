  ...
  it('renders highest impact audits in performance', async () => {
    const category: any = {
      ...
      auditRefs: [
        ...
        {result: {score: 0, scoreDisplayMode: 'numeric', title: 'Audit 1', details: {type: 'table', isOpportunity: true, summary: {wastedMs: 500}}}, weight: 0, group: 'opportunities'},
        {result: {score: 0, scoreDisplayMode: 'numeric', title: 'Audit 2', details: {type: 'table', isOpportunity: true, summary: {wastedMs: 1000}}}, weight: 0, group: 'opportunities'},
        {result: {score: 0, scoreDisplayMode: 'numeric', title: 'Audit 3', details: {type: 'table', isOpportunity: true, summary: {wastedMs: 100}}}, weight: 0, group: 'opportunities'},
        /* eslint-enable max-len */
      ],
    };
