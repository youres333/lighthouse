 ...
 * @param {DOM} dom
 */
function createTreeComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement("div", "lh-tree-container");
  const el2 = dom.createElement("style");
  el2.append("\n      .lh-tree .lh-tree-note {\n        display: flex;\n      }\n      .lh-tree .lh-tree-marker {\n        width: 12px;\n        height: 26px;\n        display: block;\n        float: left;\n        background-position: top left;\n      }\n      .lh-tree .lh-horiz-down {\n        background: url('data:image/svg+xml;utf8,<svg width=\"16\" height=\"26\" viewBox=\"0 0 16 26\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"%23D8D8D8\" fill-rule=\"evenodd\"><path d=\"M16 12v2H-2v-2z\"/><path d=\"M9 12v14H7V12z\"/></g></svg>');\n      }\n      .lh-tree .lh-right {\n        background: url('data:image/svg+xml;utf8,<svg width=\"16\" height=\"26\" viewBox=\"0 0 16 26\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M16 12v2H0v-2z\" fill=\"%23D8D8D8\" fill-rule=\"evenodd\"/></svg>');\n      }\n      .lh-tree .lh-up-right {\n        background: url('data:image/svg+xml;utf8,<svg width=\"16\" height=\"26\" viewBox=\"0 0 16 26\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M7 0h2v14H7zm2 12h7v2H9z\" fill=\"%23D8D8D8\" fill-rule=\"evenodd\"/></svg>');\n      }\n      .lh-tree .lh-vert-right {\n        background: url('data:image/svg+xml;utf8,<svg width=\"16\" height=\"26\" viewBox=\"0 0 16 26\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M7 0h2v27H7zm2 12h7v2H9z\" fill=\"%23D8D8D8\" fill-rule=\"evenodd\"/></svg>');\n      }\n      .lh-tree .lh-vert {\n        background: url('data:image/svg+xml;utf8,<svg width=\"16\" height=\"26\" viewBox=\"0 0 16 26\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M7 0h2v26H7z\" fill=\"%23D8D8D8\" fill-rule=\"evenodd\"/></svg>');\n      }\n      .lh-tree .lh-tree-tree {\n        font-size: 14px;\n        width: 100%;\n        overflow-x: auto;\n      }\n      .lh-tree .lh-tree-node {\n        height: 26px;\n        line-height: 26px;\n        white-space: nowrap;\n      }\n      .lh-tree .lh-tree-node__tree-value {\n        margin-left: 10px;\n      }\n      .lh-tree .lh-tree-node__tree-value div {\n        display: inline;\n      }\n      .lh-tree .lh-tree-initial-nav {\n        color: #595959;\n        font-style: italic;\n      }\n      .lh-tree__summary-value {\n        margin-bottom: 10px;\n      }\n\n      .lh-tree-node__tree-value pre {\n        display: inline;\n      }\n    ");
  const el3 = dom.createElement("div");
  const el4 = dom.createElement("div", "lh-tree__summary-value");
  el3.append(" ",el4," ");
  const el5 = dom.createElement("div", "lh-tree");
  el5.append(" "," ");
  el1.append(" ",el2," ",el3," ",el5," ");
  el0.append(el1);
  return el0;
}
 ...
 * @param {DOM} dom
 */
function createTreeNodeComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement("div", "lh-tree-node");
  const el2 = dom.createElement("span", "lh-tree-node__tree-marker");
  const el3 = dom.createElement("span", "lh-tree-node__tree-value");
  el1.append(" ",el2," ",el3," ");
  el0.append(el1);
  return el0;
}
...
/** @typedef {'3pFilter'|'audit'|'categoryHeader'|'chevron'|'clump'|'crc'|'crcChain'|'elementScreenshot'|'footer'|'fraction'|'gauge'|'gaugePwa'|'heading'|'metric'|'opportunity'|'opportunityHeader'|'scorescale'|'scoresWrapper'|'snippet'|'snippetContent'|'snippetHeader'|'snippetLine'|'styles'|'topbar'|'tree'|'treeNode'|'warningsToplevel'} ComponentName */
/**
 * @param {DOM} dom
...
export function createComponent(dom, componentName) {
  switch (componentName) {
    ...
    case 'tree': return createTreeComponent(dom);
    case 'treeNode': return createTreeNodeComponent(dom);
