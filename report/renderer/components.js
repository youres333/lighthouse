...
function createAuditComponent(dom) {
  ...
  el3.append(" "," ",el4," ");
  const el10 = dom.createElement("div", "lh-expandable-details__content");
  const el11 = dom.createElement("div", "lh-expandable-details__contentwrapper");
  const el12 = dom.createElement("div", "lh-audit__description");
  const el13 = dom.createElement("div", "lh-audit__stackpacks");
...
function createOpportunityComponent(dom) {
  ...
  const el5 = dom.createElement("span", "lh-audit__score-icon");
  const el6 = dom.createElement("div", "lh-audit__title");
  const el7 = dom.createElement("div", "lh-load-opportunity__sparkline");
  const el8 = dom.createElement("div", "lh-sparkline");
  const el9 = dom.createElement("div", "lh-sparkline__bar");
  el8.append(el9);
  el7.append(" ",el8," ");
  const el10 = dom.createElement("div", "lh-audit__display-text");
  const el11 = dom.createElement("div", "lh-chevron-container");
  el4.append(" ",el5," ",el6," ",el7," ",el10," ",el11," ");
  el3.append(" ",el4," ");
  const el12 = dom.createElement("div", "lh-expandable-details__content");
  const el13 = dom.createElement("div", "lh-expandable-details__contentwrapper");
  const el14 = dom.createElement("div", "lh-audit__description");
  const el15 = dom.createElement("div", "lh-audit__stackpacks");
