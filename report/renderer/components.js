...
function createTopbarComponent(dom) {
  ...
  el2.setAttribute('id', 'lighthouse');
  const el3 = dom.createElement("div", "lights");
  const el4 = dom.createElement("div", "light-left");
  const el5 = dom.createElement("div", "light-right");
  el3.append(" ",el4," ",el5," ");
  const el6 = dom.createElement("div", "roof");
  const el7 = dom.createElement("div", "building");
  const el8 = dom.createElement("div", "main");
  const el9 = dom.createElement("div", "base");
  el7.append(" ",el8," ",el9," ");
  const el10 = dom.createElement("div", "sand");
  const el11 = dom.createElement("div", "sea");
  const el12 = dom.createElement("div", "overlay");
  el2.append(" ",el3," ",el6," ",el7," ",el10," ",el11," ",el12," ");
  el0.append(el2);
  const el13 = dom.createElement("div", "lh-topbar");
  const el14 = dom.createElementNS("http://www.w3.org/2000/svg", "svg", "lh-topbar__logo");
  el14.setAttribute('viewBox', '0 0 24 24');
  const el15 = dom.createElementNS("http://www.w3.org/2000/svg", "defs");
  const el16 = dom.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
  el16.setAttribute('x1', '57.456%');
  el16.setAttribute('y1', '13.086%');
  el16.setAttribute('x2', '18.259%');
  el16.setAttribute('y2', '72.322%');
  el16.setAttribute('id', 'lh-topbar__logo--a');
  const el17 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el17.setAttribute('stop-color', '#262626');
  el17.setAttribute('stop-opacity', '.1');
  el17.setAttribute('offset', '0%');
  const el18 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el18.setAttribute('stop-color', '#262626');
  el18.setAttribute('stop-opacity', '0');
  el18.setAttribute('offset', '100%');
  el16.append(" ",el17," ",el18," ");
  const el19 = dom.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
  el19.setAttribute('x1', '100%');
  el19.setAttribute('y1', '50%');
  el19.setAttribute('x2', '0%');
  el19.setAttribute('y2', '50%');
  el19.setAttribute('id', 'lh-topbar__logo--b');
  const el20 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el20.setAttribute('stop-color', '#262626');
  el20.setAttribute('stop-opacity', '.1');
  el20.setAttribute('offset', '0%');
  const el21 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el21.setAttribute('stop-color', '#262626');
  el21.setAttribute('stop-opacity', '0');
  el21.setAttribute('offset', '100%');
  el19.append(" ",el20," ",el21," ");
  const el22 = dom.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
  el22.setAttribute('x1', '58.764%');
  el22.setAttribute('y1', '65.756%');
  el22.setAttribute('x2', '36.939%');
  el22.setAttribute('y2', '50.14%');
  el22.setAttribute('id', 'lh-topbar__logo--c');
  const el23 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el23.setAttribute('stop-color', '#262626');
  el23.setAttribute('stop-opacity', '.1');
  el23.setAttribute('offset', '0%');
  const el24 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el24.setAttribute('stop-color', '#262626');
  el24.setAttribute('stop-opacity', '0');
  el24.setAttribute('offset', '100%');
  el22.append(" ",el23," ",el24," ");
  const el25 = dom.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
  el25.setAttribute('x1', '41.635%');
  el25.setAttribute('y1', '20.358%');
  el25.setAttribute('x2', '72.863%');
  el25.setAttribute('y2', '85.424%');
  el25.setAttribute('id', 'lh-topbar__logo--d');
  const el26 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el26.setAttribute('stop-color', '#FFF');
  el26.setAttribute('stop-opacity', '.1');
  el26.setAttribute('offset', '0%');
  const el27 = dom.createElementNS("http://www.w3.org/2000/svg", "stop");
  el27.setAttribute('stop-color', '#FFF');
  el27.setAttribute('stop-opacity', '0');
  el27.setAttribute('offset', '100%');
  el25.append(" ",el26," ",el27," ");
  el15.append(" ",el16," ",el19," ",el22," ",el25," ");
  const el28 = dom.createElementNS("http://www.w3.org/2000/svg", "g");
  el28.setAttribute('fill', 'none');
  el28.setAttribute('fill-rule', 'evenodd');
  const el29 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el29.setAttribute('d', 'M12 3l4.125 2.625v3.75H18v2.25h-1.688l1.5 9.375H6.188l1.5-9.375H6v-2.25h1.875V5.648L12 3zm2.201 9.938L9.54 14.633 9 18.028l5.625-2.062-.424-3.028zM12.005 5.67l-1.88 1.207v2.498h3.75V6.86l-1.87-1.19z');
  el29.setAttribute('fill', '#F44B21');
  const el30 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el30.setAttribute('fill', '#FFF');
  el30.setAttribute('d', 'M14.201 12.938L9.54 14.633 9 18.028l5.625-2.062z');
  const el31 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el31.setAttribute('d', 'M6 18c-2.042 0-3.95-.01-5.813 0l1.5-9.375h4.326L6 18z');
  el31.setAttribute('fill', 'url(#lh-topbar__logo--a)');
  el31.setAttribute('fill-rule', 'nonzero');
  el31.setAttribute('transform', 'translate(6 3)');
  const el32 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el32.setAttribute('fill', '#FFF176');
  el32.setAttribute('fill-rule', 'nonzero');
  el32.setAttribute('d', 'M13.875 9.375v-2.56l-1.87-1.19-1.88 1.207v2.543z');
  const el33 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el33.setAttribute('fill', 'url(#lh-topbar__logo--b)');
  el33.setAttribute('fill-rule', 'nonzero');
  el33.setAttribute('d', 'M0 6.375h6v2.25H0z');
  el33.setAttribute('transform', 'translate(6 3)');
  const el34 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el34.setAttribute('fill', 'url(#lh-topbar__logo--c)');
  el34.setAttribute('fill-rule', 'nonzero');
  el34.setAttribute('d', 'M6 6.375H1.875v-3.75L6 0z');
  el34.setAttribute('transform', 'translate(6 3)');
  const el35 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el35.setAttribute('fill', 'url(#lh-topbar__logo--d)');
  el35.setAttribute('fill-rule', 'nonzero');
  el35.setAttribute('d', 'M6 0l4.125 2.625v3.75H12v2.25h-1.688l1.5 9.375H.188l1.5-9.375H0v-2.25h1.875V2.648z');
  el35.setAttribute('transform', 'translate(6 3)');
  el28.append(" ",el29," ",el30," ",el31," ",el32," ",el33," ",el34," ",el35," ");
  el14.append(" ",el15," ",el28," ");
  const el36 = dom.createElement("a", "lh-topbar__url");
  el36.setAttribute('href', '');
  el36.setAttribute('target', '_blank');
  el36.setAttribute('rel', 'noopener');
  const el37 = dom.createElement("div", "lh-tools");
  const el38 = dom.createElement("div", "lh-tools-locale lh-hidden");
  const el39 = dom.createElement("button", "lh-button lh-tool-locale__button");
  el39.setAttribute('id', 'lh-button__swap-locales');
  el39.setAttribute('title', 'Show Language Picker');
  el39.setAttribute('aria-label', 'Toggle language picker');
  el39.setAttribute('aria-haspopup', 'menu');
  el39.setAttribute('aria-expanded', 'false');
  el39.setAttribute('aria-controls', 'lh-tools-locale__selector-wrapper');
  const el40 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el40.setAttribute('width', '20px');
  el40.setAttribute('height', '20px');
  el40.setAttribute('viewBox', '0 0 24 24');
  el40.setAttribute('fill', 'currentColor');
  const el41 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el41.setAttribute('d', 'M0 0h24v24H0V0z');
  el41.setAttribute('fill', 'none');
  const el42 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el42.setAttribute('d', 'M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z');
  el40.append(el41,el42);
  el39.append(" ",el40," ");
  const el43 = dom.createElement("div", "lh-tools-locale__selector-wrapper");
  el43.setAttribute('id', 'lh-tools-locale__selector-wrapper');
  el43.setAttribute('role', 'menu');
  el43.setAttribute('aria-labelledby', 'lh-button__swap-locales');
  el43.setAttribute('aria-hidden', 'true');
  el43.append(" "," ");
  el38.append(" ",el39," ",el43," ");
  const el44 = dom.createElement("button", "lh-tools__button");
  el44.setAttribute('id', 'lh-tools-button');
  el44.setAttribute('title', 'Tools menu');
  el44.setAttribute('aria-label', 'Toggle report tools menu');
  el44.setAttribute('aria-haspopup', 'menu');
  el44.setAttribute('aria-expanded', 'false');
  el44.setAttribute('aria-controls', 'lh-tools-dropdown');
  const el45 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el45.setAttribute('width', '100%');
  el45.setAttribute('height', '100%');
  el45.setAttribute('viewBox', '0 0 24 24');
  const el46 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el46.setAttribute('d', 'M0 0h24v24H0z');
  el46.setAttribute('fill', 'none');
  const el47 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el47.setAttribute('d', 'M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z');
  el45.append(" ",el46," ",el47," ");
  el44.append(" ",el45," ");
  const el48 = dom.createElement("div", "lh-tools__dropdown");
  el48.setAttribute('id', 'lh-tools-dropdown');
  el48.setAttribute('role', 'menu');
  el48.setAttribute('aria-labelledby', 'lh-tools-button');
  const el49 = dom.createElement("a", "lh-report-icon lh-report-icon--print");
  el49.setAttribute('role', 'menuitem');
  el49.setAttribute('tabindex', '-1');
  el49.setAttribute('href', '#');
  el49.setAttribute('data-i18n', 'dropdownPrintSummary');
  el49.setAttribute('data-action', 'print-summary');
  const el50 = dom.createElement("a", "lh-report-icon lh-report-icon--print");
  el50.setAttribute('role', 'menuitem');
  el50.setAttribute('tabindex', '-1');
  el50.setAttribute('href', '#');
  el50.setAttribute('data-i18n', 'dropdownPrintExpanded');
  el50.setAttribute('data-action', 'print-expanded');
  const el51 = dom.createElement("a", "lh-report-icon lh-report-icon--copy");
  el51.setAttribute('role', 'menuitem');
  el51.setAttribute('tabindex', '-1');
  el51.setAttribute('href', '#');
  el51.setAttribute('data-i18n', 'dropdownCopyJSON');
  el51.setAttribute('data-action', 'copy');
  const el52 = dom.createElement("a", "lh-report-icon lh-report-icon--download lh-hidden");
  el52.setAttribute('role', 'menuitem');
  el52.setAttribute('tabindex', '-1');
  el52.setAttribute('href', '#');
  el52.setAttribute('data-i18n', 'dropdownSaveHTML');
  el52.setAttribute('data-action', 'save-html');
  const el53 = dom.createElement("a", "lh-report-icon lh-report-icon--download");
  el53.setAttribute('role', 'menuitem');
  el53.setAttribute('tabindex', '-1');
  el53.setAttribute('href', '#');
  el53.setAttribute('data-i18n', 'dropdownSaveJSON');
  el53.setAttribute('data-action', 'save-json');
  const el54 = dom.createElement("a", "lh-report-icon lh-report-icon--open");
  el54.setAttribute('role', 'menuitem');
  el54.setAttribute('tabindex', '-1');
  el54.setAttribute('href', '#');
  el54.setAttribute('data-i18n', 'dropdownViewer');
  el54.setAttribute('data-action', 'open-viewer');
  const el55 = dom.createElement("a", "lh-report-icon lh-report-icon--open");
  el55.setAttribute('role', 'menuitem');
  el55.setAttribute('tabindex', '-1');
  el55.setAttribute('href', '#');
  el55.setAttribute('data-i18n', 'dropdownSaveGist');
  el55.setAttribute('data-action', 'save-gist');
  const el56 = dom.createElement("a", "lh-report-icon lh-report-icon--dark");
  el56.setAttribute('role', 'menuitem');
  el56.setAttribute('tabindex', '-1');
  el56.setAttribute('href', '#');
  el56.setAttribute('data-i18n', 'dropdownDarkTheme');
  el56.setAttribute('data-action', 'toggle-dark');
  el48.append(" ",el49," ",el50," ",el51," "," ",el52," ",el53," ",el54," ",el55," ",el56," ");
  el37.append(" ",el38," ",el44," ",el48," ");
  el13.append(" "," ",el14," ",el36," ",el37," ");
  el0.append(el13);
  return el0;
}
